...
void usage()
{
	    ...
	    out("  -impute-network-data-random-training         -- use randomly sampled values for missing data for training data (default if complete data is less than 40 percent)\n"); 
